...
import { Building2, Users, Mail, Phone, ShieldCheck, X, Calendar, User as UserIcon, CheckCircle2 } from 'lucide-react';
...
const Organigrama = () => {
    ...
    const fetchOrganigrama = async () => {
        try {
            const res = await api.get('/departments/organigram-all');
